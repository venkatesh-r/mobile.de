...
var carData = {
    ...
    "images": [{
        ...
        "uri": "img.classistatic.de/api/v1/mo-storytest/images/m28AAOxyNThTcg-Y",
        "set": "fe4cfedffdffffffff"
    }, {
        "uri": "img.classistatic.de/api/v1/mo-storytest/images/znIAAOxynwlTcg-F",
        "set": "fe4cfedffdffffffff"
    }, {
        "uri": "img.classistatic.de/api/v1/mo-storytest/images/GvsAAOxyZzlTcg-L",
        "set": "fe4cfedffdffffffff"
    }, {
        "uri": "img.classistatic.de/api/v1/mo-storytest/images/Z6UAAOxyCTtTcg-L",
        "set": "fe4cfedffdffffffff"
    }],
    "price": {
        "gross": "566 €",
    ...
    "hasDamage": false,
    "isDamageCase": true,
    "htmlDescription": "Ferrari Dino 246 Dino GT 20500 km. matching numbers Car has just done a full service at ferrari with 14.000 euro spent an it is in very good conditions. 20500 km. visible in London. Please no time wasters. if you wish to come and inspect it we have a pick up service for our valuable clients from london heathrow airport. we speak english italian russian polish lithuanian. car sold new in italy.",
    "segment": "Car",
    "vc": "Car",
    "created": 1418206195,
    "adMobTargeting": {
